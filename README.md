# Terraform Demo 18 dec Configurations

This repository contains all the configuration resources required for the Terraform Demo 18 dec project to function properly and expose its business features.
